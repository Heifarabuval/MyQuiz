...
class __TwigTemplate_eabfc54b383408a982ff5ecfd82a8cc56475a35606f03c427c3aa8ffc7240c0a extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
    <div class=\"jumbotron jumbotron-fluid bg-dark mt-5 rounded text-center\">
        <div class=\"container\">
            <h1 class=\"display-4 text-light\">Inscription</h1>
        </div>
    </div>
    ";
        // line 14
    ...
    ";
        // line 15
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 15, $this->source); })()), "username", [], "any", false, false, false, 15), 'row', ["label" => "Nom d'utilisateur", "attr" => ["placeholder" => "Nom d'utilisateur.."]]);
        echo "
    ";
        // line 16
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 16, $this->source); })()), "email", [], "any", false, false, false, 16), 'row', ["label" => "Adresse email", "attr" => ["placeholder" => "Adresse email ..."]]);
        // line 17
        echo "
    ";
        // line 18
    ...
    ";
        // line 19
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 19, $this->source); })()), "confirm_password", [], "any", false, false, false, 19), 'row', ["label" => "Confirmation du mot de passe", "attr" => ["placeholder" => "Répetez le mot de passe ..."]]);
        echo "
    <div class=\"text-center\">
        <button type=\"submit\" class=\"btn btn-success mt-2 mb-4\">Inscription</button>
    </div>
...
";
    ...
    {
        return array (  123 => 24,  115 => 19,  111 => 18,  108 => 17,  106 => 16,  102 => 15,  98 => 14,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"container\">
    ...
    {{ form_row(form.email,{'label':'Adresse email','attr':{'placeholder':
    'Adresse email ...'}}) }}
    {{ form_row(form.password,{label:'Mot de passe','attr':{'placeholder':'Mot de passe ...'}}) }}
    {{ form_row(form.confirm_password,{label:'Confirmation du mot de passe','attr':{'placeholder':'Répetez le mot de passe ...'}}) }}
    <div class=\"text-center\">
        <button type=\"submit\" class=\"btn btn-success mt-2 mb-4\">Inscription</button>
    </div>
...
{% endblock %}
", "security/registration.html.twig", "/home/profchen/Documents/Epitech/Semestre2/PHP/MyQuiz/templates/security/registration.html.twig");
    }
}
