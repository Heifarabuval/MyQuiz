...
class __TwigTemplate_e62e0e1ee9adaea755e9f13de88d779b1076265124917decd909a87a5743175d extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    <a href=\"mailto:{{ field.value }}\">{{ field.formattedValue }}</a>
{% endif %}
", "@EasyAdmin/crud/field/email.html.twig", "/home/profchen/Documents/Epitech/Semestre2/PHP/MyQuiz/vendor/easycorp/easyadmin-bundle/src/Resources/views/crud/field/email.html.twig");
    }
}
